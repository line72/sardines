...
const workerCode = () => {
    let d = {
        mapCentroid: [-86.806379, 33.513501],
        build: function(geojson, population, density) {
        ...
        findDesiredFeatures: function(geojson, population, density) {
            console.log('findDesiredFeatures');
            // decide if we should use the high res or low-res
            //  version
    ...
    let onmessage = (e) => {
        ...
        //let builder = new Builder2();
        let results = d.build(e.data.geojson, e.data.population, e.data.density);
